...
class EventCard_old extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      interestedIn: false,
  ...
  componentDidMount() {
    ...
    if (this.props.state.savedEvents.includes(this.props.event._id)) {
      console.log("The currently rendered EventCard contains a saved event");
