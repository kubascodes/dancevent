        ...
        return (
            <div>
                ...
                <Modal show={this.props.show} onHide={this.props.onHide}>
                    ...
                    <form className="form-group" id="ContactForm" onSubmit={this.pushEvent}>
                        <Modal.Body>
                            <Row>
                                <Col>
                                    Write a short text for {this.props.name}. We will send {this.props.name} this text via email and add your email so you can be conntacted.
                                </Col>
                            </Row>
                            <Row>
                                <Col>
                                    <div className="form-group">
                                        ...
                                        <textarea className="form-control" name="message" id="description" onChange={this.onChangeInput} value={this.state.message} rows="4" required />
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                        ...
                        <Modal.Footer>
                            ...
                            <div className="form-group">
                                <input type="submit" className="btn button-pink" value="Contact" />
                            </div>
