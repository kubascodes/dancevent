  ...
  render() {
    ...
    return (
      ...
      <div className="form-group">
        ...
        <input className="mr-1" type="radio" name="gender" id="gender" value="male" onChange={this.onChangeCheckbox} checked={this.state.gender ? this.state.gender.includes("male") : false} />
        <label className="radio-inline mr-2" for="inlineRadio1">Male</label>

        <input className="mr-1" type="radio" name="gender" id="gender" value="female" onChange={this.onChangeCheckbox} checked={this.state.gender ? this.state.gender.includes("female") : false} />
        <label className="radio-inline mr-2" for="inlineRadio2">Female</label>

        <input className="mr-1" type="radio" name="gender" id="gender" value="other" onChange={this.onChangeCheckbox} checked={this.state.gender ? this.state.gender.includes("other") : false}  />
      ...
      <div className="form-group">
        <label className="mr-2 label-bold" htmlFor="listOfDanceStyles">Preferred Dance Styles</label>
          ...
          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="latin" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("latin") : false} />
          <label class="checkbox-inline mr-2">Latin</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="cha-cha-cha" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("cha-cha-cha") : false}  />
          <label class="checkbox-inline mr-2">Cha-cha-cha</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="samba" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("samba") : false}  />
          <label class="checkbox-inline mr-2">Samba</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="jive" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("jive") : false}  />
          <label class="checkbox-inline mr-2">Jive</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="paso doble" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("paso doble") : false }  />
          <label class="checkbox-inline mr-2">Paso Doble</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="boldero" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("boldero") : false}  />
          <label class="checkbox-inline mr-2">Boldero</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="rumba" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("rumba") : false}  />
          <label class="checkbox-inline mr-2">Rumba</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="east coast swing" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("east coast swing") : false}  />
          <label class="checkbox-inline mr-2">East Coast Swing</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="standard" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("standard") : false} />
          <label class="checkbox-inline mr-2">Standard</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="waltz" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("waltz") : false}  />
          <label class="checkbox-inline mr-2">Waltz</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="viennese waltz" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("viennese waltz") : false}  />
          <label class="checkbox-inline mr-2">Viennese Waltz</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="tango" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("tango") : false}  />
          <label class="checkbox-inline mr-2">Tango</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="foxtrot" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("foxtrot") : false}  />
          <label class="checkbox-inline mr-2">Foxtrot</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="quickstep" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("quickstep") : false}  />
          <label class="checkbox-inline mr-2">Quickstep</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="hustle" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("hustle") : false}  />
          <label class="checkbox-inline mr-2">Hustle</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="west coast swing" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("west coast swing") : false}  />
          <label class="checkbox-inline mr-2">West Coast Swing</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="salsa" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("salsa") : false}  />
          <label class="checkbox-inline mr-2">Salsa</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="bachata" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("bachata") : false}  />
          <label class="checkbox-inline mr-2">Bachata</label>

          <input className="mr-1" type="checkbox" id="listOfDanceStyles" name="listOfDanceStyles" value="various" onChange={this.onChangeCheckbox} checked={this.state.listOfDanceStyles ? this.state.listOfDanceStyles.includes("various") : false}  />
      ...
      <div className="form-group">
        <label className="mr-2 label-bold" htmlFor="proficiencyLevel">Dance Proficiency Level</label>
          ...
          <input className="mr-1" type="radio" id="proficiencyLevel" name="proficiencyLevel" onChange={this.onChangeCheckbox} value="beginner" checked={this.state.proficiencyLevel ? this.state.proficiencyLevel.includes("beginner") : false} />
          <label class="radio-inline mr-2">Beginner</label>

          <input className="mr-1" type="radio" id="proficiencyLevel" name="proficiencyLevel" onChange={this.onChangeCheckbox} value="intermediate" checked={this.state.proficiencyLevel ? this.state.proficiencyLevel.includes("intermediate") : false} />
          <label class="radio-inline mr-2">Intermediate</label>

          <input className="mr-1" type="radio" id="proficiencyLevel" name="proficiencyLevel" onChange={this.onChangeCheckbox} value="advanced" checked={this.state.proficiencyLevel ? this.state.proficiencyLevel.includes("advanced") : false} />
      ...
      <div className="form-group">
        ...
        <input className="mr-1" type="radio" name="prefGender" id="prefGender" value="male" onChange={this.onChangeCheckbox} checked={this.state.prefGender ? this.state.prefGender.includes("male") : false} />
        <label className="radio-inline mr-2" for="inlineRadio1">Male</label>

        <input className="mr-1" type="radio" name="prefGender" id="prefGender" value="female" onChange={this.onChangeCheckbox} checked={this.state.prefGender ? this.state.prefGender.includes("female") : false} />
        <label className="radio-inline mr-2" for="inlineRadio2">Female</label>

        <input className="mr-1" type="radio" name="prefGender" id="prefGender" value="other" onChange={this.onChangeCheckbox} checked={this.state.prefGender ? this.state.prefGender.includes("other") : false} />
        <label className="radio-inline mr-2" for="inlineRadio3">Other</label>
      </div>
