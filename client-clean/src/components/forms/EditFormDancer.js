      ...
      >
        ...
        <div className="form-group">
          ...
          <input
            ...
            checked={
              this.state.gender ? this.state.gender.includes("male") : null
            }
          />
          ...
          <input
            ...
            onChange={this.onChangeCheckbox}
            checked={
              this.state.gender ? this.state.gender.includes("female") : null
            }
          />
          ...
          <input
            ...
            onChange={this.onChangeCheckbox}
            checked={
              this.state.gender ? this.state.gender.includes("other") : null
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={this.onChangeCheckbox}
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("latin")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("cha-cha-cha")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("samba")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("jive")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("paso doble")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("boldero")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("rumba")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("east coast swing")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("standard")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("waltz")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("viennese waltz")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("tango")
                : null
            }
          />
          ...
          <input
            ...
            cchecked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("foxtrot")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("quickstep")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("hustle")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("west coast swing")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("salsa")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("bachata")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.listOfDanceStyles
                ? this.state.listOfDanceStyles.includes("various")
                : null
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            value="beginner"
            checked={
              this.state.proficiencyLevel
                ? this.state.proficiencyLevel.includes("beginner")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.proficiencyLevel
                ? this.state.proficiencyLevel.includes("intermediate")
                : null
            }
          />
          ...
          <input
            ...
            checked={
              this.state.proficiencyLevel
                ? this.state.proficiencyLevel.includes("advanced")
                : null
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            checked={
              this.state.prefGender
                ? this.state.prefGender.includes("male")
                : null
            }
          />
          <label className="radio-inline mr-2" for="inlineRadio1">
          ...
          <input
            ...
            checked={
              this.state.prefGender
                ? this.state.prefGender.includes("female")
                : null
            }
          />
          <label className="radio-inline mr-2" for="inlineRadio2">
          ...
          <input
            ...
            checked={
              this.state.prefGender
                ? this.state.prefGender.includes("other")
                : null
            }
          />
          <label className="radio-inline mr-2" for="inlineRadio3">
