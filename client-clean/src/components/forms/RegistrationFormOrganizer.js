      ...
      >
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="email"
            onChange={this.onChangeInput}
            placeholder="private@email.com (required)"
            value={this.email}
            required
          />
        </div>
        ...
        <div className="form-group">
          <label className="label-bold" htmlFor="publicEmail">
            Public Email
          </label>
          <input
            type="email"
            ...
            name="publicEmail"
            onChange={this.onChangeInput}
            placeholder="public@email.com (required)"
            value={this.publicEmail}
            required
          />
        </div>

        <div className="form-group">
          <label className="label-bold" htmlFor="phone">
            Phone
          </label>
          <input
            type="number"
        ...
        <div className="form-group">
          <label className="label-bold" htmlFor="street">
            Street
          </label>
          <input
            type="text"
            className="form-control border-red"
            id="street"
            placeholder="Gisselstraße 4 (required)"
            name="street"
            onChange={this.onChangeInput}
            value={this.street}
            required
        ...
        <div className="form-group">
          <label className="label-bold" htmlFor="description">
            Description
          </label>
          <textarea
