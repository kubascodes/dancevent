...
class FindDancePartnerView extends React.Component {
  ...
  sortingChanged = (selectedOption, action) => {
    ...
    //sort date new to old
      ...
      this.state.requests.sort((a, b) =>
        a.event.startDate < b.even5r4t.startDate
          ? 1
          : a.event.startDate > b.event.startDate
          ? -1
          : 0
            ...
            <Col>
              ...
              <Row>
                <div className="form-group" style={{ marginRight: "auto" }}>
                  <input
                    ...
                    value="viewAllRequests"
                    onChange={this.onChangeCheckbox}
                  />
                  <label class="checkbox-inline mr-2">View all Requests </label>
                  <label
                    class="checkbox-inline mr-2"
                    style={{ color: "#ce9aa3" }}
                  >
                    (including mismatches to my profile){" "}
                  </label>
                </div>
              ...
              <Row>
                ...
                {this.state.requests.length ? (
                  ...
                  <p>
                    {" "}
                    At the moment there are <b>no open requests</b> that are{" "}
                    <b>matching</b> your profile or filter.{" "}
                  </p>
                )}
              </Row>
            </Col>
