    ...
    return (
      ...
      <form className="form-group" id="EventCreationForm" onSubmit={this.pushEvent}>
        ...
        <div className="form-group">
            ...
            <input type="text" className="form-control" id="city" placeholder="Munich" name="city" onChange={this.onChangeInput} value={this.city} required/>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
            ...
            <select multiple className="form-control" id="listOfProficiencyLevels" name="listOfProficiencyLevels" onChange={this.onChangeMultipleSelect}>
        ...
        <div className="custom-file">
          <input type="file" className="custom-file-input" name="picture" onChange={this.onChangeInput} id="customFile" />
          <label className="custom-file-label" htmlFor="customFile">Upload your profile picture</label>
        </div>
      </div>
