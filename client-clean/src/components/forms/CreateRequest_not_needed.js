    ...
    if (window.sessionStorage.secret_token != null) {
        ...
        return (
          <div className="form-group">
            ...
            >
              <Modal.Header closeButton>
                {" "}
                <Modal.Title>Unvalid Action!</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <p>
                  You are logged in as an Organizer. Only dancers can create
                  partner requests for events.
                </p>
              </Modal.Body>
              <Modal.Footer>
                <Button variant="secondary" onClick={this.handleCancel}>
      ...
      return (
        <div className="container">
          ...
          <p>
            {" "}
            Please {<Link to={{ pathname: "login" }}>login</Link>},to create a
            request.
          </p>
          {/* Alternative to link:
